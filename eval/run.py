"""Run the rag-agentic-2025 retrieval evaluation against the live database.
...
def main(k: int = None) -> dict:
    ...
    print(
        f"rag-agentic-2025 retrieval evaluation (k={k}, {results['questions']} questions)"
    )
    print(
